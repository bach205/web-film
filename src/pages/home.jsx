    ...
    return (
        ...
        <div >
            <ContentBanner src={'https://trailer.vieon.vn/Teaser_BachNguyetPhanTinh_mkt.mp4'} title={"Bạch Nguyệt Phạn Tinh"} description={movie[0].description}
                item={movie[0]} />
            <div className='content-container'>
                <ContentContainerSlider label={"Thịnh Hành"} array={(Array.isArray(movie)) ? movie : []} />
                <img src={peaky} alt='theme' title='theme' width={"100%"} height={"220px"} style={{ margin: "30px 0" }} />
                <ContentContainerList label={"Phim Bộ"} array={(Array.isArray(movie)) ? movie : []} />
                <img src={natra} alt='theme' title='theme' width={"100%"} height={"220px"} style={{ margin: "30px 0" }} />
                <ContentContainerList label={"Phim Lẻ"} array={(Array.isArray(movie)) ? movie : []} />
                <img src={bleach} alt='theme' title='theme' width={"100%"} height={"220px"} style={{ margin: "30px 0" }} />
                <ContentContainerList label={"Anime"} array={(Array.isArray(movie)) ? movie : []} />
            </div>
        </div>
    )
}
